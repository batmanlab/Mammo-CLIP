#!/bin/sh
#SBATCH --output=/restricted/projectnb/batmanlab/shawn24/PhD/Mammo-CLIP/src/psc_logs/b2_det_lp_%j.out
...
slurm_output_train_mass=/restricted/projectnb/batmanlab/shawn24/PhD/Mammo-CLIP/src/psc_logs/clip_train/b2_det_lp_mass_$CURRENT.out
slurm_output_train_calc=/restricted/projectnb/batmanlab/shawn24/PhD/Mammo-CLIP/src/psc_logs/clip_train/b2_det_lp_calc_$CURRENT.out
...
python ./src/codebase/train_detector.py \
  ...
  --clip_chk_pt_path "/restricted/projectnb/batmanlab/shawn24/PhD/Mammo-CLIP/src/codebase/outputs/img_text_clip/b2_detector_period_n/checkpoints/fold_0/b2-model-best-epoch-7.tar" \
  --dataset 'ViNDr' \
  --arch 'breast_clip_b2' \
  --epochs 120 \
  --batch-size 7 \
