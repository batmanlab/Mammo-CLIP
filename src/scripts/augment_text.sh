#!/bin/sh
#SBATCH --output=/ocean/projects/asc170022p/shg121/PhD/Mammo-CLIP/src/psc_logs/mammo-clip/misc/back_translation_wo_period_%j.out
...
slurm_output_train1=/ocean/projects/asc170022p/shg121/PhD/Mammo-CLIP/src/psc_logs/mammo-clip/misc/back_translation_wo_period_$CURRENT.out
