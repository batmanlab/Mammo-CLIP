#!/bin/sh
#SBATCH --output=/ocean/projects/asc170022p/shg121/PhD/Mammo-CLIP/src/psc_logs/b2_det_ft_%j.out
...
slurm_output_train_mass=/ocean/projects/asc170022p/shg121/PhD/Mammo-CLIP/src/psc_logs/clip_train/b2_det_ft_mass_$CURRENT.out
slurm_output_train_calc=/ocean/projects/asc170022p/shg121/PhD/Mammo-CLIP/src/psc_logs/clip_train/b2_det_ft_calc_$CURRENT.out
